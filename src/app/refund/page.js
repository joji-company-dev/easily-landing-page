    ...
    <div className="mx-auto max-w-3xl px-6 pb-24 pt-32">
      ...
      <Article title="2. 환불(전액) 조건">
        ...
        <p className="font-medium text-foreground">
          ② 서비스 미사용 — 기획안 생성, 외부 영상 링크 분석을 한 번도 사용하지 않은 경우
        </p>
      ...
      <Article title="4. 환불 불가 사유">
        ...
        <p>2. 기획안 생성, 외부 영상 링크 분석 중 하나라도 사용한 경우</p>
        <p>3. 프로모션 또는 할인 적용 결제로서 별도 환불 조건이 명시된 경우</p>
      </Article>

      <Article title="5. 시스템 오류 보상">
        <p>1. 시스템 오류로 기획안 생성·외부 영상 링크 분석이 완료되기 전에 실패한 경우, 고객센터로 문의하시면 사용 횟수를 복구해 드립니다.</p>
