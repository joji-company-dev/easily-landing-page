...
export const ContainerScroll = ({ titleComponent, children }) => {
  ...
  const scaleDimensions = () => {
    return isMobile ? [0.9, 0.7] : [1.05, 1];
  };
...
export const Card = ({ rotate, scale, children }) => {
  return (
    <motion.div
      ...
      className="aspect-[9/16] max-w-5xl -mt-12 mx-auto h-[50rem] md:h-[50rem] w-full border-4 border-[#525252] p-2 md:p-6 bg-[#faf2e880] rounded-[30px] shadow-2xl"
    >
