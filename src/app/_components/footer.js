...
import { COMPANY_INFO } from "../_consts/company";
  ...
  return (
    <div className="w-full p-10 h-auto bg-black text-white">
      ...
      <p className="text-lg text-muted-foreground text-gray-50">
        ...
        <br />
        contact mail : {COMPANY_INFO.Email}
        <br />
        contact tel : {COMPANY_INFO.Tel}
      </p>
      <br />
      <a
        href={COMPANY_INFO.Service}
        className="text-lg text-muted-foreground text-gray-100"
      >
        서비스약관
      </a>
      <br />
      <a
        href={COMPANY_INFO.Userule}
        className="text-lg text-muted-foreground text-gray-100"
      >
        개인정보이용약관
      </a>
